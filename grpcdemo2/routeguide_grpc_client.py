import grpc
from grpcdemo2 import routeguide_pb2_grpc,routeguide_pb2,routeguide_db
import random
...
def generate_route(feature_list):
    for _ in range(0,20):
        ...
        print("random feature {name} at {location}".format(
            name = random_feature.name,
            location = random_feature.location))
...
def generate_route_note():
    msgs =[
        ...
        make_route_note('msg 2', 0, 0),
        make_route_note('msg 3', 0, 0),
        make_route_note('msg 4', 0, 0),
        make_route_note('msg 5', 0, 0),
    ]
    for msg in msgs:
